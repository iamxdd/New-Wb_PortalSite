	...
	var i, n, a = e.layui && layui.define,
		...
		r = {
			...
			link: function(t, n, a) {
				if(r.path) {
					...
					var l = (a || t).replace(/\.|\//g, ""),
						f = "layuicss-" + l,
						c = 0;
					s.rel = "stylesheet", s.href = t, s.id = f, i("#" + f)[0] || o.appendChild(s), "function" == typeof n && ! function u() {
			...
			ready: function(e) {
				var t = "skinlayercss",
					i = "303";
				return a ? layui.addcss("/New Wb_PortalSite/css/common/layer.css?v=" + r.v + i, e, t) : r.link("/New Wb_PortalSite/css/common/layer.css?v=" + r.v + i, e, t), this
			},
